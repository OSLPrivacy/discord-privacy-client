...
producer-owned bundle. Its `build-identity.json`, exact executable and loader, dist, source archive,
dist archive/manifest, raw npm setup/build and Cargo stdout/stderr, and closed build log are all
