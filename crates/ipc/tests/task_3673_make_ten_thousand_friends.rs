...
#[test]
fn make_ten_thousand_test_friends() {
    ...
    println!(
        "TASK_3673_MAKE_TEN_THOUSAND_FRIENDS created_count={} all_count={} online_count={} pending_count={} blocked_count={} first_friend_id_pattern=MAPLE-3673-00001 last_friend_id_pattern=MAPLE-3673-10000",
        FRIEND_COUNT,
        tabs.all.len(),
        tabs.online.len(),
        tabs.pending.len(),
