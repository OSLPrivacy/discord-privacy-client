...
const FRIEND_COUNT: usize = 1_000;
...
fn make_thousand_test_friends() {
    ...
    println!(
        "TASK_3673_THOUSAND_FRIENDS created_count={} all_count={} online_count={} pending_count={} blocked_count={} first_friend_id=MAPLE-3673-00001 last_friend_id=MAPLE-3673-01000",
        FRIEND_COUNT,
        tabs.all.len(),
        tabs.online.len(),
        tabs.pending.len(),
