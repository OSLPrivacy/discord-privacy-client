...
mod command_activity_tests {
    ...
    #[test]
    fn record_activity_on_every_command_resets_inactivity_deadline() {
...
pub(crate) fn record_activity_on_every_command_at(now: std::time::Instant) -> bool {
    if crate::main_password::run_inactivity_auto_lock_timer_at(now) {
        return false;
    }
...
pub fn cmd_osl_verify_gate_password(
    ...
    match outcome {
        ...
        GatePasswordAttemptResult::DuressCredential { attempts_used } => {
