...
mod tests {
    ...
    #[test]
    fn register_request_carries_signed_nonzero_rn_capability_floor() {
    ...
    #[test]
    fn client_rotation_never_lowers_signed_rn_capability_floor() {
    ...
    #[test]
    fn hosted_request_ownership_challenge_round_trips_through_mock_server() {
        let nonce = [0x5au8; PROOF_CHALLENGE_NONCE_BYTES];
    ...
    #[test]
    fn fetch_identity_bundle_composes_signed_pubkeys_and_prekey_bundle() {
