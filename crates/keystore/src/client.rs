...
mod tests {
    ...
    #[test]
    fn register_request_carries_nonzero_rn_capability_floor() {
    ...
    #[test]
    fn client_rotation_never_lowers_rn_capability_floor() {
    ...
    #[test]
    fn request_ownership_challenge_round_trips_through_basic_mock_server() {
        let nonce = [0x5au8; PROOF_CHALLENGE_NONCE_BYTES];
    ...
    #[test]
    fn fetch_identity_bundle_composes_pubkeys_and_prekey_bundle() {
