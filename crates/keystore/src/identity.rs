//! Identity keypair: X25519 + ML-KEM-768 long-term identity keys.
//!
//! Held in memory as raw bytes (with `zeroize` on the secret halves)
//! and reconstituted into [`crypto::x25519::SecretKey`] /
//! [`crypto::ml_kem_768::DecapsulationKey`] on demand.
//!
