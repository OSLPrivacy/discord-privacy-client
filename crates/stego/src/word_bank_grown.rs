...
static GROWN_BANK: [&str; GROWN_BANK_SIZE] = [
    ...
    "his", "its", "our", "their", "this", "that", "these", "those", "here", "there", "now",
    "then", "today", "tomorrow", "yesterday", "tonight", "morning", "afternoon", "evening",
    "night", "week", "weekend", "month", "year", "hour", "minute", "second", "good", "bad",
    "great", "nice", "fine", "okay", "sure", "right", "wrong", "true", "false", "real", "fake",
    "happy", "sad", "tired", "excited", "bored", "angry", "calm", "relaxed", "stressed",
    "worried", "nervous", "love", "like", "hate", "want", "need", "miss", "hope", "wish", "plan",
    "think", "know", "feel", "believe", "say", "tell", "ask", "answer", "talk", "chat", "speak",
    "listen", "hear", "see", "look", "watch", "read", "write", "go", "come", "stay", "leave",
    "arrive", "return", "walk", "run", "drive", "ride", "fly", "travel", "move", "eat", "drink",
    "cook", "bake", "order", "shop", "buy", "sell", "pay", "spend", "save", "earn", "borrow",
    "lend", "work", "study", "learn", "teach", "practice", "train", "build", "fix", "break",
    "clean", "wash", "play", "game", "sport", "team", "match", "win", "lose", "score", "goal",
    "point", "rule", "field", "court", "music", "song", "album", "band", "concert", "show",
    "movie", "film", "series", "episode", "story", "book", "page", "chapter", "novel", "poem",
    "letter", "note", "message", "email", "call", "text", "friend", "family", "brother", "sister",
    "mother", "father", "parent", "child", "kid", "baby", "neighbor", "home", "house", "room",
    "kitchen", "bedroom", "bathroom", "garden", "yard", "street", "city", "town", "car", "bus",
    "plane", "bike", "boat", "road", "path", "bridge", "station", "airport", "port", "phone",
    "computer", "laptop", "tablet", "screen", "camera", "photo", "video", "internet", "website",
    "weather", "rain", "snow", "sun", "cloud", "wind", "storm", "heat", "cold", "warm", "cool",
    "mild", "humid", "color", "red", "blue", "green", "yellow", "black", "white", "gray",
    "purple", "orange", "pink", "brown", "food", "breakfast", "lunch", "dinner", "snack", "meal",
    "recipe", "restaurant", "cafe", "bakery", "water", "coffee", "tea", "juice", "soda", "milk",
    "bread", "rice", "pasta", "salad", "soup", "fruit", "door",
];
...
mod tests {
    ...
    fn grown_bank_no_duplicate_entries() {
        ...
        assert_eq!(set.len(), GROWN_BANK.len(), "GROWN_BANK contains a duplicate word");
    }
