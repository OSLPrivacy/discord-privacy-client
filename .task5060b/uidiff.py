...
APP = os.path.join(HERE, 'audit-app')
PAIRS = [
...
# Task-local focused copy: retain only the requested pair while exercising the
# same uidiff implementation and its missing-file validation.
PAIRS = [('Home_friends_collapsed', 'home-friends-collapsed')]
