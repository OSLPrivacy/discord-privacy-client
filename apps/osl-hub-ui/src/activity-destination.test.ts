...
describe("Activity destination", () => {
  it("renders Activity as the proof destination with recorded events", () => {
  ...
  it("exposes Activity IA route and avoids implementation-facing copy", () => {
    const { activityDestinationContent, fixedIaRoutePreview } = ui;
