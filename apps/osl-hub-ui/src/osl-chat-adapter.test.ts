...
describe("first-party OSL Chat IPC", () => {
  ...
  it("delivers bounded text and strictly parses the authenticated inbox batch", async () => {
    mocks.invoke
      ...
      .mockResolvedValueOnce({ messages: [{ messageId: "peer-0123456789abcdef0123456789abcdef", coverPointer: "cover prose", plaintext: "hello\nworld", contextVerified: true, personToPersonE2ee: true, viewOnceConsumed: false, createdAt: 1_999_996_400, expiresAt: 2_000_000_000 }], pendingViewOnce: [], acknowledgments: [], fetched: 1, decryptDisplayEnabled: true, deferredRows: 0, unrecognizedWireRows: 0 });
