...
describe("bundled preview security boundary", () => {
  ...
  it("grants the preview UI only local, main-window capabilities", () => {
    ...
    expect(capability.permissions).toEqual([
      ...
      "allow-open-external-link-in-default-browser",
      "allow-lock-hub-session",
      "allow-schedule-protected-clipboard-clear",
      ...
      "allow-list-osl-notes",
      "allow-save-osl-note",
      "allow-delete-osl-note",
    ...
    for (const [permission, command] of [
      ...
      ["allow-open-external-link-in-default-browser", "open_external_link_in_default_browser"],
      ["allow-lock-hub-session", "lock_hub_session"],
      ["allow-schedule-protected-clipboard-clear", "schedule_protected_clipboard_clear"],
