...
function harness() {
  ...
  return {
    app, phraseForm, phrase, passwordForm, password, confirm, continueButton, passwordEye, confirmEye, back, nodes,
    all(selector: string): FakeElement[] { return selector === "[data-password-toggle]" ? [passwordEye, confirmEye] : []; },
  };
}
