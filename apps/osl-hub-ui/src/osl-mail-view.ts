...
function transitBadge(transit: "oslE2ee" | "externalSmtp"): string {
  return transit === "oslE2ee"
    ? '<span class="osl-mail-transit is-e2ee" title="Encrypted between verified OSL identities">OSL E2EE</span>'
    : '<span class="osl-mail-transit is-smtp" title="Ordinary email transit outside OSL">External SMTP</span>';
}
