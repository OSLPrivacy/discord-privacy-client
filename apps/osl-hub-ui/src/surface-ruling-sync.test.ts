...
describe("surface ruling synchronization", () => {
  it("keeps every executable enumeration reconciled to the 2026-08-05 ruling", () => {
    ...
    const checkedLists: CheckedList[] = [
      { name: "ruling chat carriers", actual: ruling.chat_carriers, expected: ["discord", "signal", "whatsapp", "telegram", "x"] },
      ...
      { name: "ruling cut_surfaces", actual: ruling.cut_surfaces, expected: ["instagram", "snapchat", "messenger", "slack", "linkedin", "teams"] },
