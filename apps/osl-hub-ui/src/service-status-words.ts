 ...
 *
 * TASK 0763 built {@link checkPlainEnglishScreenWords}, which reads only the words a person
...
export function checkServiceStatusWords(
  ...
  const base = checkPlainEnglishScreenWords(markup, {
  ...
  return {
    ...
    authored: {
      ...
      banned: findPlainEnglishBannedWords(authoredText, bannedWords),
