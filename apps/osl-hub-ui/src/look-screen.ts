...
export function lookScreenMarkup(state: LookState): string {
  ...
  return `<section class="look-screen" aria-labelledby="look-title" data-look-screen>
    ...
    <div class="look-layout">
      ...
      <section class="look-reset"><div><strong>Reset look</strong><small>Return every look choice to OSL’s defaults.</small></div><button class="button" type="button" data-look-reset data-settings-reset="Look">Reset</button></section>
