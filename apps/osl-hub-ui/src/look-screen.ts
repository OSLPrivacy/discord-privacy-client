...
export function lookScreenMarkup(state: LookState): string {
  ...
  return `<section class="look-screen" aria-labelledby="look-title" data-look-screen>
    <header class="look-heading"><p class="eyebrow">Settings</p><h2 id="look-title">Look</h2><p>Change how OSL appears on this device. These choices never affect messages or other people.</p></header>
    <div class="look-layout">
      <section class="look-group look-mode-group" aria-labelledby="look-mode-title"><h3 id="look-mode-title">Mode</h3><p class="look-group-note">Choose the base brightness.</p><div class="look-choice-row">${modeChoices.map(([value, label, detail]) => choice("mode", value, label, detail, state.mode === value)).join("")}</div></section>
