 ...
 *
 * Eight choices, each with one plain line saying what lives behind it. The
 * label alone does not tell a non-technical user whether "Scrub" deletes their
...
export const settingsHomeChoices: readonly SettingsHomeChoice[] = [
  ...
  },
  {
    id: "apps",
    label: "Apps",
    explanation: "Which apps and accounts OSL may open, and the browser it uses.",
  },
  {
    id: "whitelisting",
    label: "Whitelisting",
