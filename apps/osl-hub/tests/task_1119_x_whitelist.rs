...
const ACCOUNT_A: &str = "x-account-a-1119";
const ACCOUNT_B: &str = "x-account-b-1119";
const KINDS: [&str; 2] = ["direct_message", "public_post"];
...
#[test]
fn task_1119_commands_store_then_remove_every_x_allowance_without_one_way_tick() {
    let dir = TempDir::new().expect("create task 1119 store");
    ...
    for kind in KINDS {
        ...
        println!(
            "TASK1119 kind={kind} add_commands=2 remove_commands=2 two_way_tick={} first_one_way_tick={} second_one_way_tick={} final_state={}",
    ...
    println!(
        "TASK1119 kinds={} add_commands={adds} remove_commands={removes} two_way_visible_ticks={two_way_ticks} one_way_visible_ticks={one_way_visible_ticks} final_allowance_count={}",
        KINDS.join(","),
        final_list["count"],
    );
