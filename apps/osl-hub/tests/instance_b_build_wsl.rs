...
#[cfg_attr(
    not(feature = "never"),
    ignore = "runs a real cargo/frontend build; under nextest it deadlocks on the global osl-cargo lock. Run explicitly: cargo test -p osl-privacy-hub --test instance_b_build_wsl -- --ignored"
)]
