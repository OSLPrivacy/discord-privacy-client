...
pub enum QuarantineReason {
    ...
    ArchiveScanTime,
    ArchiveUnsafeEntry,
    // TASK 5180a: the hostile-entry rejections, each named separately so a
    // refusal says which shape of entry stopped the archive.
    ArchiveAbsolutePath,
    ArchiveParentTraversal,
    ArchiveSymbolicLink,
    ArchiveHardLink,
    ArchiveSpecialFile,
    ArchiveUnsupported,
...
impl QuarantineReason {
    pub fn name(self) -> &'static str {
        match self {
            ...
            QuarantineReason::ArchiveAbsolutePath => "archive_absolute_path",
            QuarantineReason::ArchiveParentTraversal => "archive_parent_traversal",
            QuarantineReason::ArchiveSymbolicLink => "archive_symbolic_link",
            QuarantineReason::ArchiveHardLink => "archive_hard_link",
            QuarantineReason::ArchiveSpecialFile => "archive_special_file",
