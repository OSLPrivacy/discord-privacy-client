...
use ipc::commands::{
    ...
    cmd_init_keyserver,
    cmd_load_identity,
    cmd_osl_accept_saved_friend_request,
    cmd_osl_apply_burn,
    cmd_osl_block_saved_friend_request,
    cmd_osl_bulk_set_whitelist,
    cmd_osl_bulk_unwhitelist_scope,
    cmd_osl_burn_engage,
    cmd_osl_burn_message,
    cmd_osl_burn_password_status,
    cmd_osl_burn_scope_data,
    cmd_osl_change_main_password,
    cmd_osl_clear_license,
    cmd_osl_create_friend_request,
    cmd_osl_decrypt_message_v2,
    cmd_osl_decline_saved_friend_request,
    cmd_osl_encrypt_message,
    cmd_osl_encrypt_message_v2,
    cmd_osl_get_identity_info,
    cmd_osl_get_license_state,
    cmd_osl_get_scope_encryption_state,
    cmd_osl_get_scope_whitelist_summary,
    cmd_osl_get_self_user_id,
    cmd_osl_get_tier_gate_status,
    cmd_osl_list_all_whitelists,
    cmd_osl_list_burned_scopes,
    cmd_osl_list_friend_requests,
    cmd_osl_load_channel_history,
    cmd_osl_lockout_status,
    cmd_osl_mark_scope_burned,
    cmd_osl_password_status,
    cmd_osl_persist_edit,
    cmd_osl_register_self_snowflake,
    cmd_osl_remove_burn_password,
    cmd_osl_remove_main_password,
    cmd_osl_remove_stealth_password,
    cmd_osl_send_burn_marker,
    cmd_osl_set_burn_password,
    cmd_osl_set_main_password,
    cmd_osl_set_main_password_after_recovery,
    cmd_osl_set_stealth_password,
    cmd_osl_set_whitelist,
    cmd_osl_stealth_mode_engage,
    cmd_osl_stealth_password_status,
    cmd_osl_toggle_scope_encryption,
    cmd_osl_unburn_scope,
    cmd_osl_unwhitelist_scope,
    cmd_osl_validate_license,
    cmd_osl_verify_gate_password,
    cmd_osl_verify_main_password,
    cmd_osl_verify_recovery_phrase,
    cmd_osl_view_recovery_phrase,
    cmd_register,
    cmd_save_identity,
    cmd_status,
    cmd_stego_decode,
    cmd_stego_encode,
    cmd_x25519_diffie_hellman,
    AeadOpenRequest,
    AeadSealRequest,
    AeadSealResponse,
    BurnScopeDataDto,
    BurnedScopeDto,
    FetchPubkeysResponse,
    GateVerifyDto,
    ...
    SavedFriendRequestListDto,
    ScopeEncryptionState,
    ScopeWhitelistSummary,
    StatusResponse,
    StegoDecodeResponse,
    StegoEncodeRequest,
    StegoEncodeResponse,
    ...
    EmailSendModeDto,
    EmailWhitelistKindDto,
    RemoveSenderMessageRecordsDto,
    TheirSideBurnDto,
    RecoveryWordRetypeCheckDto,
    RecoveryWordRetypeEntryDto,
    cmd_aead_open, cmd_aead_seal, cmd_fetch_pubkeys, cmd_generate_identity, cmd_init_keyserver,
    cmd_load_identity, cmd_osl_accept_saved_friend_request, cmd_osl_apply_burn,
    cmd_osl_block_saved_friend_request, cmd_osl_bulk_set_whitelist, cmd_osl_bulk_unwhitelist_scope,
    cmd_osl_burn_engage, cmd_osl_burn_message, cmd_osl_burn_password_status,
    cmd_osl_burn_scope_data, cmd_osl_change_main_password, cmd_osl_clear_license,
    cmd_osl_create_friend_request, cmd_osl_decrypt_message_v2, cmd_osl_decline_saved_friend_request,
    cmd_osl_encrypt_message, cmd_osl_encrypt_message_v2,
    ...
    cmd_osl_list_all_whitelists, cmd_osl_list_burned_scopes, cmd_osl_list_friend_requests,
...
#[tauri::command]
async fn osl_create_friend_request(
    app: tauri::AppHandle,
    request_id: String,
    requester_id: String,
    target_id: String,
...
#[tauri::command]
async fn osl_list_friend_requests(
    app: tauri::AppHandle,
) -> Result<SavedFriendRequestListDto, String> {
    let app_handle = app.clone();
    tauri::async_runtime::spawn_blocking(move || {
        let state = app_handle.state::<AppState>();
        cmd_osl_list_friend_requests(state.inner())
    })
    .await
    .map_err(|e| format!("OSL: join error: {e}"))?
}
...
#[tauri::command]
async fn osl_accept_friend_request(
    app: tauri::AppHandle,
    request_id: String,
) -> Result<SavedFriendRequestDto, String> {
    let app_handle = app.clone();
    tauri::async_runtime::spawn_blocking(move || {
        let state = app_handle.state::<AppState>();
        cmd_osl_accept_saved_friend_request(state.inner(), request_id)
    })
    .await
    .map_err(|e| format!("OSL: join error: {e}"))?
}
...
#[tauri::command]
async fn osl_decline_friend_request(
    app: tauri::AppHandle,
    request_id: String,
) -> Result<SavedFriendRequestDto, String> {
    let app_handle = app.clone();
    tauri::async_runtime::spawn_blocking(move || {
        let state = app_handle.state::<AppState>();
        cmd_osl_decline_saved_friend_request(state.inner(), request_id)
    })
    .await
    .map_err(|e| format!("OSL: join error: {e}"))?
}
...
#[tauri::command]
async fn osl_block_friend_request(
    app: tauri::AppHandle,
    request_id: String,
) -> Result<SavedFriendRequestDto, String> {
    let app_handle = app.clone();
    tauri::async_runtime::spawn_blocking(move || {
        let state = app_handle.state::<AppState>();
        cmd_osl_block_saved_friend_request(state.inner(), request_id)
    })
    .await
    .map_err(|e| format!("OSL: join error: {e}"))?
}
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            osl_set_friend_ids,
            osl_get_friend_ids,
            osl_create_friend_request,
            osl_list_friend_requests,
            osl_accept_friend_request,
            osl_decline_friend_request,
