...
setup, and reports whether local cleanup completed. The sign-in burn
path also invokes the journaled `DuressEngine` held by the IPC app
state. Apparent-unlock copy remains intentionally absent.
