...
| View-once, timed deletion, attachments | `implemented-unwired` | master §9 rows | "Planned." Master §8.2 forbids marketing these as available before the exact release build has evidence. |
