...
> Claim-gate source SHA-256: `c974ea6757aa79b54c125c5695c18fe1527ab3d4492f8aa56c6e1fb75334d7c0`
...
These support-status phrasings are forbidden unless a future row replaces this section
with service-specific evidence and status. They overstate the versioned support matrix
because they read as available/general support rather than `Planned`, `Experimental`,
`Externally blocked`, `Unsupported`, or exact QA-build evidence.

| Forbidden phrase | Why it is forbidden |
|---|---|
| **"Works on Signal" / "Works on WhatsApp" / "Works on Telegram" / "Works on Outlook"** | Signal and WhatsApp need their own runtime proofs, stable Telegram remains externally blocked until its accessible message-row probe succeeds, and Outlook is scoped as staged OSL Mail rather than chat-overlay support. |
